// ***Welcome to my Project! I super hope you like musicals...***
...
$(document).ready(function() {
		...
		if (screenID >= whereResultScreenStarts) {
			for (let currentScreen in resultScreen) {
				...
				if (resultScreenObject.resultID === screenID) {
					...
					$(".result").show();
					$("h2").replaceWith(
						`<h2 class="resultH2">${resultScreenObject.h2}</h2>`
					);
					$(".showPhoto").replaceWith(`${resultScreenObject.photo}`);
					$(".showContent").replaceWith(
						`<div><p class="resultContent">${resultScreenObject.showDescription}</p></div>`
					);
				}
			}
		} else {
	...
	const resultScreen = {
		screen5: {
			...
			photo: `<a href="https://www.mirvish.com/shows/summer" target="_blank"><img class="summerResult" src="./assets/Summer.jpg" alt="a showposter in blues of Summer with Donna Summer on it"></a>`,
			showDescription:
		...
		screen6: {
			...
			photo: `<a href="https://www.mirvish.com/shows/les-miserables" target="_blank"><img class="lesMizResult" src="./assets/lesMiz.png" alt="a Les Miserables showposter in black, white, red, and blue with classic Young Cosette on it"></a>`,
			showDescription:
		...
		screen7: {
			...
			photo: `<a href="https://www.mirvish.com/shows/come-from-away" target="_blank"><img class="comeFromAwayResult" src="./assets/CFA.jpg" alt="a showposter in bright blues and yellows of Come From Away with the words the hit musical based on the remarkable true story below the title">`,
			showDescription:
		...
		screen8: {
			...
			photo: `<a href="https://www.mirvish.com/shows/the-boy-friend target="_blank"><img class="boyfriendResult" src="./assets/Boyfriend.jpg" alt="a showposter in light blues of The Boyfriend with a couple on a speedboat"></a>`,
			showDescription:
				"The Boy Friend will star beloved stage and screen actor Kelsey Grammer. One of the most well-loved British musicals of all time, The Boyfriend is Sandy Wilson's all-singing all-dancing love letter to 1920s musical comedies.",
		},
		screen9: {
			resultID: 9,
			h2: `Check out <span class="italic">Hamilton</span>!`,

			photo: `<a href="https://www.mirvish.com/shows/hamilton target="_blank"><img class="hamiltonResult" src="./assets/hamilton.jpg" alt="a showposter in gold and black of Hamilton with Alexander Hamilton on a star"></a>`,
	...
	// ***When you push the Try Again button at the end, the following code is executed to bring you back to the start of the game***
